    ...
    <div className={cn('flex flex-col min-h-0 h-full', className)}>
      <div className="px-4 sm:px-5 py-4 border-b border-[#e8edf2] flex items-center justify-between shrink-0 bg-white">
        ...
        <button
          type="button"
          onClick={onClose}
          className="w-8 h-8 rounded-full border border-[#e8edf2] hover:border-[#FF5B00]/30 flex items-center justify-center text-[#8a9bb0] hover:text-[#EF3C23] transition-colors cursor-pointer shrink-0"
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 space-y-3 min-h-0 no-scrollbar">
        {cartItems.length === 0 ? (
          <div className="py-10 text-center flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#e8edf2] bg-[#F8FAFC] flex items-center justify-center text-[#FF5B00]">
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  <button
                    type="button"
                    onClick={() => openProduct(item)}
                    className="text-[11px] font-bold text-[#1A1D4E] uppercase tracking-tight line-clamp-2 text-left hover:text-[#EF3C23] transition-colors w-full"
                  >
                    {product.title}
                  </button>
