        ...
        >
          ...
          {scale <= 1 && (
            <div className="absolute bottom-4 right-4 bg-black/55 text-white border border-white/20 px-3 py-1.5 text-[9px] font-black uppercase tracking-wider rounded-full flex items-center gap-1.5 hidden md:flex backdrop-blur-md">
              <ZoomIn size={12} className="text-[#FF5B00]" /> Hover to magnify · Click for fullscreen
            </div>
          )}
          {scale <= 1 && (
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'border-[#FF5B00] scale-105 shadow-md shadow-[#FF5B00]/15'
              ...
              {safeItems.map((_, i) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeIndex === i ? 'w-9 bg-[#FF5B00]' : 'w-2 bg-white/22 hover:bg-white/40',
                  )}
