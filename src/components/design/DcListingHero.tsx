...
/**
 * Choosify.dc.html listing/discover hero —
 * navy gradient, title with gradient pill, glass search, quick chips.
 */
export function DcListingHero({
  ...
  return (
    <div
      className={cn(
        'relative px-5 sm:px-10 pt-14 pb-14 text-center text-white overflow-hidden',
        className,
      )}
