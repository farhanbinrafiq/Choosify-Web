      ...
      <div className="px-5 pb-5 -mt-10 relative">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
          {profile.logoUrl ? (
            ...
            <span className="w-20 h-20 rounded-full border-4 border-white bg-[#FF5B00]/10 text-[#FF5B00] text-2xl font-black flex items-center justify-center shadow-md">
          ...
          <div className="flex-1 min-w-0 text-left">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {profile.isVerified && <BadgeCheck size={18} className="text-[#FF5B00]" aria-label="Verified" />}
            </div>
