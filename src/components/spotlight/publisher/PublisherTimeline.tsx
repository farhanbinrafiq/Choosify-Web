    ...
    <ol className="relative border-l-2 border-[#e8edf2] ml-3 pl-4 space-y-4 text-left">
      {timeline.events.map((event) => (
        <li key={event.eventId} className="relative">
          <span className="absolute -left-[1.35rem] top-1 w-3 h-3 rounded-full bg-[#EB4501] border-2 border-white" />
          <p className="text-[10px] font-bold uppercase tracking-wider text-[#EB4501]">
