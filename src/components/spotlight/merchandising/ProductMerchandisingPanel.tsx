      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            ...
            {selectedIds.size > 0 && (
              <>
                <button type="button" onClick={bulkAttach} className="text-[10px] px-2 py-1 bg-[#FF5B00] text-white rounded font-bold">
                ...
                <li key={p.id}>
                  <button
                    ...
                    className={cn(
                      ...
                      isAttached ? 'bg-green-50 border border-green-200' : isSelected ? 'bg-[#FF5B00]/10' : 'hover:bg-gray-50',
                    )}
                  >
                    <input
                      type="checkbox"
          ...
          {hasMore && (
            <button type="button" onClick={loadMore} className="mt-2 text-xs text-[#FF5B00] font-bold">
              Load more…
            </button>
          )}
        </div>
