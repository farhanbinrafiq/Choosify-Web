  ...
  const body = (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        ...
        {(href || onDrillDown) && (
          <ChevronRight size={16} className="text-gray-300 group-hover:text-[#EF3C23] shrink-0 mt-1" />
        )}
      </div>
      ...
      {(href || onDrillDown) && (
        <span className="text-[10px] font-bold uppercase text-[#FF5B00] opacity-0 group-hover:opacity-100 transition-opacity">
          View Details
        </span>
      )}
    </div>
