      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {serviceIds.map((serviceId) => {
          ...
          return (
            ...
            >
              <span className="w-10 h-10 rounded-[5px] bg-[#FF5B00]/10 text-[#FF5B00] flex items-center justify-center shrink-0">
                <Briefcase size={18} />
              </span>
              ...
              <Link
                ...
                className="shrink-0 inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-wide text-[#FF5B00] hover:underline"
              >
                View
                <ArrowRight size={10} />
              </Link>
