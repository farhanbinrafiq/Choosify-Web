    ...
    <div className="mb-8 space-y-4" role="search" aria-label="Spotlight filters">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <input
          ...
          className="flex-1 min-w-[200px] px-3 py-2 text-sm border border-[#e8edf2] rounded-[5px] focus:outline-none focus:border-[#FF5B00]/50"
        ...
        <button
          ...
          className="text-[10px] font-bold uppercase text-gray-400 hover:text-[#EF3C23]"
        >
          Clear
        </button>
      </div>
