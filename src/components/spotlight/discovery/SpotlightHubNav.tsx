    ...
    >
      {items.map((item) => (
        <Link
          ...
          to={item.href}
          className={cn(
            'shrink-0 px-3 py-2 min-h-[44px] inline-flex items-center text-[10px] font-bold uppercase tracking-wide rounded border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5B00]',
            item.isActive
