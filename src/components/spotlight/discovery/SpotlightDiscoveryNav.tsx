        ...
        {SPOTLIGHT_DISCOVERY_NAV.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.href}
              className={cn(
                'shrink-0 px-4 py-2.5 min-h-[44px] inline-flex items-center rounded-full text-[10px] font-black uppercase tracking-wider border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5B00]',
                active
