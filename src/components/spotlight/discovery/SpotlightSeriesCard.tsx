...
export function SpotlightSeriesCard({ series }: SpotlightSeriesCardProps) {
  ...
  return (
    <Link
      ...
      className="group flex gap-3 p-3 bg-white border border-[#e8edf2] rounded-[5px] hover:border-[#FF5B00]/40 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5B00] min-h-[88px]"
