  ...
  return (
    <header className="h-14 border-b border-[#e8edf2] bg-white flex items-center justify-between px-4 gap-3 shrink-0">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button type="button" onClick={onPreview} className="inline-flex items-center gap-1 px-3 py-1.5 text-[10px] font-bold uppercase border border-[#e8edf2] rounded hover:border-[#FF5B00]/40">
          <Eye size={12} /> Preview
        </button>
        <button type="button" onClick={onSave} className="inline-flex items-center gap-1 px-3 py-1.5 text-[10px] font-bold uppercase border border-[#e8edf2] rounded hover:border-[#FF5B00]/40">
          <Save size={12} /> Save
        </button>
        {onSubmit && (
        ...
        {onPublish && (
          <button type="button" onClick={onPublish} className="inline-flex items-center gap-1 px-3 py-1.5 text-[10px] font-bold uppercase bg-[#FF5B00] text-white rounded">
