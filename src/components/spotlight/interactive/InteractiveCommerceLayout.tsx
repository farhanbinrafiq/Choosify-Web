  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {isUpcoming && event.scheduledAt && (
        <div className="mb-6 p-6 border border-dashed border-[#FF5B00]/30 rounded-[5px] bg-[#FFF8F4] text-center">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-[#FF5B00] text-white text-xs font-black uppercase rounded"
          >
            Notify Me
          </button>
