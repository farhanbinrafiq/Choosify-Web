  ...
  return (
    <header className="text-left mb-4">
      <div className="flex flex-wrap items-center gap-2 mb-2">
        ...
        <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase bg-[#FF5B00]/10 text-[#FF5B00] border border-[#FF5B00]/20">
      ...
      <p className="text-[10px] font-bold uppercase text-[#FF5B00] mt-3">{resolvePrimaryInteractiveCtaLabel(event)}</p>
    </header>
  );
}
