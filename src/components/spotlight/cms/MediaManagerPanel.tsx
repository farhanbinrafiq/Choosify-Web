...
export function MediaManagerPanel({ mediaIds, primaryMediaId, onChange }: MediaManagerPanelProps) {
  ...
  return (
    <div className="space-y-4">
      <div
        className="border-2 border-dashed border-[#e8edf2] rounded-lg p-8 text-center cursor-pointer hover:border-[#FF5B00]/40"
        ...
        {items.map((media, index) => (
          <li
            ...
            className={cn(
              ...
              primaryMediaId === media.mediaId ? 'border-[#FF5B00]' : 'border-[#e8edf2]',
            )}
          >
            ...
            <div className="flex items-center gap-1">
              <button type="button" onClick={() => onChange(mediaIds, media.mediaId)} title="Set primary">
                <Star size={16} className={primaryMediaId === media.mediaId ? 'text-[#FF5B00] fill-[#FF5B00]' : 'text-gray-300'} />
              </button>
