    ...
    <div className="w-full flex flex-col gap-5">
      ...
      <div 
        className={cn(
          ...
          currentMedia.type === 'video' ? 'bg-black' : isB2B ? 'bg-slate-50' : 'bg-[#1e2256]/30'
        )}
          ...
          >
            {currentMedia.type === 'video' ? (
              ...
              >
                ...
                {!isZooming && (
                  <div className="absolute bottom-4 right-4 bg-navy/80 backdrop-blur-xs text-white border border-white/15 px-3 py-1.5 text-[9px] font-black uppercase tracking-wider rounded-lg flex items-center gap-1.5 shadow-sm opacity-60 group-hover:opacity-100 transition-opacity">
