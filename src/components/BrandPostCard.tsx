  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'hover:border-[#FF5B00]/35 hover:shadow-md transition-all duration-300 text-left h-full',
    ...
    >
      ...
      <div className={cn('flex flex-col flex-1 gap-2', compact ? 'p-3' : 'p-4')}>
        ...
        <h3 className={cn(
          'font-bold text-[#1A1D4E] leading-snug line-clamp-2 group-hover:text-[#EF3C23] transition-colors',
        ...
        <div className={cn('mt-auto border-t border-[#e8edf2]', compact ? 'pt-2 space-y-1' : 'pt-3 space-y-1.5')}>
          {dateLabel && (
            <div className="flex items-center gap-1.5 text-[10px] font-semibold text-[#1A1D4E]/80">
              <CalendarDays size={compact ? 11 : 12} className="text-[#FF5B00] shrink-0" />
        ...
        <div className={cn(
          'flex items-center gap-1 font-black uppercase tracking-wider text-[#FF5B00]',
