...
export const SummaryCard = ({ overallWinner }: { overallWinner: any }) => {
  return (
    <div className="choosify-dark-surface rounded-xl p-8 md:p-10 flex flex-col lg:flex-row items-center gap-10 shadow-2xl mb-16 relative overflow-hidden ">
      {/* Subtle Glow */}
      ...
      <div className="w-full lg:w-[350px] shrink-0 bg-white/5 rounded-[10px] p-6  relative overflow-hidden flex flex-col">
      ...
      <div className="flex-1 text-white z-10">
        ...
        <div className="flex flex-wrap items-start justify-between gap-8">
          <div>
            ...
            <Link to="/products/1" className="text-[#FF5B00] font-bold flex items-center gap-1 text-sm hover:text-[#EF3C23] transition-colors group">
          ...
          <div className="bg-white/5 rounded-[20px] p-6 text-center min-w-[150px]">
            ...
            <div className="text-5xl font-extrabold text-[#FF5B00] mb-2">{overallWinner.score}</div>
