          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button 
                ...
                className="bg-[#FF5B00] hover:bg-[#EF3C23] text-white px-8 py-3.5 rounded-full font-bold transition-all flex items-center gap-2 shadow-lg shadow-[#FF5B00]/20"
              >
              ...
              <button 
                ...
                className={cn(
                  ...
                  isSaved ? "bg-white text-[#18154C]" : "bg-white/10 text-white hover:bg-white/20"
                )}
              >
                <Heart
                  className="w-5 h-5 text-[#FF5B00]"
                  strokeWidth={2}
            ...
            <div className="aspect-[4/3] md:aspect-video lg:aspect-[4/5] rounded-none overflow-hidden shadow-2xl relative group bg-black">
              {isPlayingVideo && (content.videoUrl || content.duration) ? (
                ...
                <>
                  ...
                  <button 
                    onClick={() => setIsPlayingVideo(true)}
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-white/25 backdrop-blur-md text-white border border-white/30 rounded-full flex items-center justify-center hover:scale-110 hover:bg-[#EF3C23] transition-all duration-300 shadow-xl shadow-black/20"
                  >
