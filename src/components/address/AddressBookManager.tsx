...
function AddressCard({
  ...
  return (
    <article className="bg-white border border-[#E8EDF2] rounded-[10px] p-5 hover:border-[#FF5B00]/30 transition-all text-left h-full flex flex-col">
...
export function AddressBookManager({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {customerAddresses.length === 0 ? (
        ...
        <div
          className={cn(
            ...
            !embedded && defaultCustomerAddress
      ...
      {embedded && defaultCustomerAddress && customerAddresses.length > 0 && (
        <CheckoutPreviewCard address={defaultCustomerAddress} />
      )}
