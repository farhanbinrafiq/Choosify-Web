  ...
  return (
    <div className="inline-block max-w-sm m-1 text-left">
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 text-[#18154C] text-xs font-bold hover:bg-slate-100 hover:border-slate-300 transition-all cursor-pointer shadow-sm active:scale-[0.98]"
      >
