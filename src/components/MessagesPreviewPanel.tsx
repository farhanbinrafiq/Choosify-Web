      ...
      <div className="px-4 sm:px-5 py-4 border-b border-[#e8edf2] flex items-center justify-between shrink-0 bg-white gap-3">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-9 h-9 rounded-full bg-[#FF5B00]/10 flex items-center justify-center text-[#FF5B00] shrink-0">
            <MessageCircleMore size={16} className="text-[#FF5B00]" />
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-full border border-[#e8edf2] hover:border-[#FF5B00]/30 flex items-center justify-center text-[#8a9bb0] hover:text-[#EF3C23] transition-colors cursor-pointer"
