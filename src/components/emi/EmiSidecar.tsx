    ...
    >
      {!open ? (
        <button
          ...
          className="pointer-events-auto flex items-center gap-2 px-3 py-2 bg-white border border-[#e8edf2] rounded-full shadow-md hover:border-[#FF5B00]/40 text-left"
          aria-label="Open Emi contextual assistant"
        >
          <Sparkles size={14} className="text-[#FF5B00] shrink-0" />
        ...
        <div className="pointer-events-auto bg-white border border-[#e8edf2] rounded-[5px] shadow-lg overflow-hidden">
          <div className="flex items-center justify-between px-3 py-2 border-b border-[#e8edf2] bg-[#fafbfc]">
            <span className="text-[10px] font-black uppercase text-[#FF5B00] flex items-center gap-1">
