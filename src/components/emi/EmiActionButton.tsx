  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'border-[#EB4501] bg-[#FFF0E8] text-[#EB4501]'
          : 'border-[#e8edf2] bg-white text-gray-600 hover:border-[#EB4501]/40 hover:text-[#CF4400]',
  ...
  return (
    <div className="mt-2 p-3 bg-[#fafbfc] border border-[#e8edf2] rounded-[5px] text-left space-y-2">
      <p className="text-xs text-gray-700 leading-relaxed flex gap-2">
        <Sparkles size={14} className="text-[#EB4501] shrink-0 mt-0.5" aria-hidden />
        {suggestion}
      </p>
      {why && <p className="text-[10px] text-gray-400"><strong className="text-gray-500">Why:</strong> {why}</p>}
      {applyHint && <p className="text-[10px] text-[#EB4501]/80">{applyHint}</p>}
      {onDismiss && (
