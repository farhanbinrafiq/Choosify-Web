...
export const VerdictCard: React.FC<VerdictCardProps> = ({
  ...
  return (
    <div className={cn("choosify-dark-surface rounded-[32px] p-8 md:p-10 text-white relative overflow-hidden", className)}>
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#FF5B00]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-10 items-start">
        {overallRating !== undefined && (
          <div className="flex flex-col items-center justify-center p-6 bg-white/5 border border-white/10 rounded-2xl shrink-0">
            ...
            <div className="text-6xl font-black text-[#FF5B00] tracking-tighter leading-none mb-1">
        ...
        <div className="flex-1 space-y-6">
          <div>
            <h3 className="text-xl font-black text-white uppercase tracking-wider flex items-center gap-2 mb-3">
              <Trophy className="w-5 h-5 text-[#FF5B00]" /> THE VERDICT
            </h3>
          ...
          {recommendation && (
            <div className="pt-4 border-t border-white/10">
              <p className="text-sm font-bold text-white flex items-start gap-2">
                <span className="text-[#FF5B00]">Recommendation:</span> {recommendation}
              </p>
            </div>
          )}
