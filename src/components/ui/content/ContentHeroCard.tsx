        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6 flex flex-col items-start space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <Button onClick={onSave} variant={isSaved ? "primary" : "outline"} className={cn("gap-2 border-white/20", isSaved ? "bg-white text-[#18154C] border-transparent" : "text-white hover:bg-white/10")}>
                <Heart
                  size={16}
          ...
          <div className="lg:col-span-6 relative group">
            ...
            <div className="relative aspect-[4/3] rounded-none overflow-hidden border border-white/10 shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#18154C] via-transparent to-transparent opacity-80" />
            </div>
          </div>
        </div>
      </div>
