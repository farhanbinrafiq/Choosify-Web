  ...
  return (
    <div className={cn("bg-white rounded-2xl border border-slate-100 p-6 flex flex-col", className)}>
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-12 h-12 rounded-2xl bg-[#2323FF]/10 flex items-center justify-center shrink-0">
          <ShieldCheck className="w-7 h-7 text-[#2323FF]" />
        </div>
          ...
          return (
            <div key={idx} className="flex flex-col gap-1.5">
              ...
              <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-[#2323FF] rounded-full transition-all duration-1000 ease-out" 
