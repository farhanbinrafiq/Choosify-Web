            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Button 
                  ...
                  className="px-8 py-4 bg-[#FF5B00] hover:bg-[#EF3C23] text-white rounded-xl font-bold uppercase tracking-wider text-sm transition-all shadow-[0_0_20px_rgba(255, 91, 0,0.3)] border-transparent"
                >
