      ...
      <div className="mt-4 mb-2 rounded-[20px] bg-white border border-[#eef2f6] shadow-lg p-5 md:p-8 text-left">
        <div className="flex items-start justify-between gap-4 pb-5 mb-6 border-b border-[#eef2f6]">
          <div className="flex items-center gap-4 min-w-0">
            <div className="w-12 h-12 rounded-2xl bg-[#F7F8FA] flex items-center justify-center shrink-0 ring-2 ring-[#FF5B00]/10">
          ...
          <button
            ...
            className="w-9 h-9 rounded-full border border-[#eef2f6] hover:border-[#FF5B00]/30 flex items-center justify-center text-[#8a9bb0] hover:text-[#EF3C23] transition-colors bg-white shrink-0"
            ...
            <div className="flex flex-wrap gap-2.5">
              {category.subcategories.map((sub, index) => (
                <motion.button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#F7F8FA] hover:bg-[#FFF8F4] border border-transparent hover:border-[#FF5B00]/20 text-sm font-medium text-[#1A1D4E] hover:text-[#EF3C23] transition-all duration-200 min-h-[44px]"
                  onClick={() => {
          ...
          <div className="flex flex-wrap gap-3">
            {brandNames.map((brand) => (
              <Link
                ...
                className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-white border border-[#eef2f6] shadow-sm hover:shadow-md hover:border-[#FF5B00]/20 hover:-translate-y-0.5 transition-all duration-200 min-h-[48px] text-sm font-semibold text-[#1A1D4E] hover:text-[#EF3C23]"
              >
                {brand}
              </Link>
            ))}
          ...
          <section className="mb-8" aria-labelledby={`${category.id}-products`}>
            <div className="flex items-end justify-between gap-3 mb-4">
              ...
              <Link
                ...
                className="text-[11px] font-bold uppercase tracking-wider text-[#FF5B00] hover:underline inline-flex items-center gap-1"
              >
              ...
              {categoryGuides.map((guide) => (
                ...
                >
                  ...
                  <div className="min-w-0 py-0.5">
                    <span className="text-[9px] font-black uppercase tracking-wider text-[#FF5B00]">Guide</span>
                    <p className="text-sm font-semibold text-[#1A1D4E] line-clamp-2 group-hover:text-[#EF3C23] transition-colors">
                      {guide.title}
                    </p>
                  </div>
                </Link>
