  ...
  return (
    <div className="fixed inset-0 z-[120] flex justify-end font-sans">
      <button
        ...
        className="absolute inset-0 bg-[#18154C]/45"
        onClick={closeEditor}
      />
      <aside className="relative w-full max-w-md h-full bg-white border-l border-[#E8EDF2] shadow-2xl flex flex-col">
        ...
        <div className="px-5 py-4 border-t border-[#E8EDF2] flex items-center gap-2 bg-white">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#18154C] text-white text-[13px] font-bold tracking-tight hover:bg-[#EF3C23] transition-colors"
          >
            <Save size={13} />
            Save draft
          </button>
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[#E8EDF2] text-[13px] font-bold tracking-tight text-[#9AA0AC] hover:text-[#EF3C23] hover:border-[#FF5B00]/30 transition-colors"
          >
            <Trash2 size={13} />
            Clear
          </button>
