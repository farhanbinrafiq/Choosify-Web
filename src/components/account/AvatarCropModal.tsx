 ...
 * Ported from choosify-admin-4.0's src/components/account/AvatarCropModal.tsx —
 * keep the two in sync; this is intentionally dependency-free (React + motion
 * only) so it could be ported without pulling in any dashboard-only code.
 */
