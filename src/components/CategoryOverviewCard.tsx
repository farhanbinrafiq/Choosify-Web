...
export const CategoryOverviewCard = memo(function CategoryOverviewCard({
  id,
  title,
  ...
  // Safe dummy execution if handleItemClick is invoked
  const triggerItemClick = (e: React.MouseEvent, item: string) => {
    e.stopPropagation();
    if (handleItemClick) {
