              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <form onSubmit={handleAuthSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full mt-5 bg-gradient-to-r from-[#FF5B00] to-[#EB4501] text-white h-13 rounded-2xl font-black text-xs uppercase tracking-wider shadow-lg shadow-[#FF5B00]/25 flex items-center justify-center gap-2 cursor-pointer transition-all hover:brightness-110 active:scale-[0.99]"
                    >
                      <span>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex flex-col gap-2.5">
                        ...
                        <button
                          ...
                          className="w-full bg-white hover:bg-slate-50 border border-slate-200/80 h-11 rounded-xl text-[11px] font-bold text-slate-800 transition-all flex items-center justify-center gap-2.5 shadow-sm"
                        >
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          <button
                            ...
                            className="bg-white hover:bg-slate-50 border border-slate-200/80 h-11 rounded-xl text-[11px] font-bold text-slate-800 transition-all flex items-center justify-center gap-2 shadow-sm"
                          >
