          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-sans text-sm font-semibold uppercase tracking-tight text-[#1A1D4E] leading-snug">
                For Business <span className="text-[#FF5B00] italic">& Sellers</span>
              </h3>
            ...
            actions={
              (selectedLetter || searchQuery || activeTab !== 'All Brands' || selectedCategory || verificationFilter !== 'all' || popularityFilter !== 'all') ? (
                <button
                  ...
                  className="text-[9.5px] font-black text-orange-primary uppercase tracking-widest hover:underline flex items-center gap-1.5 transition-all bg-white border border-[#eef2f6] px-3.5 py-2 rounded-full shadow-sm hover:text-[#EF3C23] cursor-pointer"
                >
                  Reset All Filters
                </button>
              ) : null
          ...
          <div className="lg:hidden bg-white rounded-2xl p-4 border border-[#eef2f6] shadow-sm mb-6 font-sans">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-[#FF5B00]/10 text-[#FF5B00] text-[9px] font-black uppercase rounded-full leading-none">
