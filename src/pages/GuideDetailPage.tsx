    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="w-full bg-[#FAF9F5] border-b border-gray-100 py-4 shadow-xs text-left">
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="flex flex-col text-left">
               <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1 font-mono">PRODUCTS REVIEWED</span>
               <span className="text-sm font-black text-navy uppercase italic">{allGuideProducts.length || 8} ITEMS</span>
            </div>
            <div className="flex flex-col text-left border-l border-gray-100 pl-4 md:pl-6">
               <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1 font-mono">OVERALL WINNER</span>
               <span className="text-sm font-black text-[#E8500A] uppercase italic truncate">
                  {displayProducts[0] ? `${displayProducts[0].brand} ${displayProducts[0].title}` : "Samsung Galaxy S26 Ultra"}
               </span>
            </div>
            <div className="flex flex-col text-left border-l border-gray-100 pl-4 md:pl-6">
               <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1 font-mono">BEST BUDGET</span>
               <span className="text-sm font-black text-blue-500 uppercase italic truncate">
                  {(() => {
                     ...
                     return cheapest ? `${cheapest.brand} ${cheapest.title}` : "Samsung Galaxy A56";
                  })()}
               </span>
            </div>
            <div className="flex flex-col text-left border-l border-gray-100 pl-4 md:pl-6">
               <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1 font-mono">LAST UPDATED</span>
               <span className="text-sm font-black text-navy uppercase italic">June 2026</span>
            </div>
         </div>
      </div>
      ...
      <div id="all-section" className="scroll-mt-36">
         <div className="max-w-[1440px] mx-auto px-6 w-full py-12">
            <div className="grid grid-cols-1 lg:grid-cols-[250px_minmax(0,1fr)_250px] xl:grid-cols-[300px_minmax(0,1fr)_280px] gap-8 xl:gap-12 items-start w-full relative">
               ...
               <aside className="hidden lg:flex flex-col gap-6 sticky top-[160px] h-[calc(100vh-180px)] overflow-y-auto no-scrollbar pb-10 flex-shrink-0">
                  ...
                  <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm text-left">
                     <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">HOW THIS REVIEW WAS MADE</h4>
                     <div className="space-y-2 text-left">
                       {[
                         { label: "Tested For 30 Days", icon: <CalendarDays size={13} className="text-[#E8500A]" /> },
                         { label: "Compared With 8 Competitors", icon: <Layers size={13} className="text-[#1B5CFF]" /> },
               ...
               <main className="flex-1 min-w-0 flex flex-col gap-12">
                  ...
                  <div id="winner" className="scroll-mt-36">
                     <div className="mb-4 text-left">
                        <h2 className="text-2xl font-black text-[#1A1D4E] italic tracking-tighter uppercase mb-0.5">#1 OVERALL WINNER PRODUCT</h2>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] italic">The highest performing option matching overall metrics</p>
                     </div>
                       ...
                       <div id="prod-sec-0" className="group relative w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 flex flex-col hero-gradient text-white p-6 md:p-10 mb-8 mt-2 scroll-mt-36">
                          ...
                          <div className="relative w-full aspect-[21/10] md:aspect-[21/9] rounded-xl overflow-hidden mb-6 flex items-center justify-center bg-white border border-white/5 shadow-inner">
                             ...
                             <div className="absolute bottom-4 left-6 right-6 flex items-end justify-between z-10">
                               <div className="text-left">
                                 <span className="text-[8px] font-black uppercase tracking-widest text-[#FF5C38] bg-white/10 px-2.5 py-1 rounded border border-white/10 font-mono">OVERALL CHAMPION</span>
                                 <h3 className="text-xl md:text-3xl font-black text-white uppercase italic tracking-tighter leading-none mt-1">
                          ...
                          <div className="mt-8 border-t border-white/10 pt-6">
                             <h4 className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-4 text-left font-mono">OUR SCORE MATRIX</h4>
                             <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                                {[
                                   ...
                                   <div key={i} className="bg-white/5 rounded-xl p-3 border border-white/5 flex flex-col justify-between text-left">
                                      <span className="text-[8px] font-bold text-white/50 uppercase tracking-wider leading-tight mb-2 line-clamp-1">{item.label}</span>
                                      <div className="flex items-baseline gap-1">
                                         <span className="text-lg font-black text-[#FF5C38] leading-none font-mono">{item.val}</span>
                                         <span className="text-[8px] text-white/20 font-mono">/10</span>
                                      </div>
                                      <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden mt-2">
                                         <div className="h-full bg-[#FF5C38]" style={{ width: `${item.val * 10}%` }} />
                                      </div>
                                   </div>
                                ))}
                             </div>
                  ...
                  <div id="why-won" className="scroll-mt-36">
                     <div className="mb-4 text-left">
                        <h2 className="text-2xl font-black text-[#1A1D4E] italic tracking-tighter uppercase mb-0.5">#1 WHY THIS WON</h2>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] italic">Crucial hardware & testing decision signals</p>
                     </div>
                     <div className="flex flex-wrap gap-2.5">
                        {[
                           { text: "Industry-Leading Reliability", icon: "✓", color: "bg-emerald-500/10 border-emerald-500/20 text-emerald-600" },
                           { text: "Best-in-Class Hardware Specification", icon: "✦", color: "bg-blue-500/10 border-blue-500/20 text-blue-600" },
                           { text: "Double-Inspected Sourcing Trust", icon: "🛡️", color: "bg-[#E8500A]/10 border-[#E8500A]/20 text-[#E8500A]" },
                           { text: "Zero Interest Monthly EMI Approved", icon: "৳", color: "bg-purple-500/10 border-purple-500/20 text-purple-600" },
                           { text: "Immediate Metro Shipping Certified", icon: "🗲", color: "bg-yellow-500/10 border-yellow-500/20 text-yellow-700 font-bold" },
                           { text: "Longer Extended Manufacturer Support", icon: "⏳", color: "bg-teal-500/10 border-teal-500/20 text-teal-600" }
                        ].map((chip, idx) => (
                           <span key={idx} className={cn("px-4 py-2 text-[10px] font-black uppercase tracking-wider border rounded-xl flex items-center gap-1.5", chip.color)}>
                  ...
                  <div id="quick-verdict" className="scroll-mt-36">
                     <div className="mb-4 text-left">
                        <h2 className="text-2xl font-black text-[#1A1D4E] italic tracking-tighter uppercase mb-0.5">RECOMMENDATION & QUICK VERDICT</h2>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] italic">High level, scannable advice</p>
                     </div>
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-5 text-left shadow-sm">
                           ...
                           <ul className="space-y-1.5 pl-1.5 list-none">
                              {["High daily usage & professionals", "Premium display enthusiasts", "Zero hassle long-term support"].map((item, i) => (
                                 <li key={i} className="text-[10px] font-bold uppercase text-navy/70 flex items-center gap-1.5">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-5 text-left shadow-sm">
                           ...
                           <ul className="space-y-1.5 pl-1.5 list-none">
                              {["Ultra-tight budget buyers", "Compact pocket lovers", "Sourcing-indifferent shoppers"].map((item, i) => (
                                 <li key={i} className="text-[10px] font-bold uppercase text-navy/70 flex items-center gap-1.5">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-5 text-left shadow-sm">
                           ...
                           <ul className="space-y-1.5 pl-1.5 list-none">
                              {["Exquisite screen brightness", "Stunning camera outputs", "Superfast thermal cooling"].map((item, i) => (
                                 <li key={i} className="text-[10px] font-bold uppercase text-navy/70 flex items-center gap-1.5">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-5 text-left shadow-sm">
                           ...
                           <ul className="space-y-1.5 pl-1.5 list-none">
                              {["High stock demand limits", "Explicit premium price bar", "Requires premium charger/accessories"].map((item, i) => (
                                 <li key={i} className="text-[10px] font-bold uppercase text-navy/70 flex items-center gap-1.5">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#E8500A]/50 shrink-0" /> {item}
                                 </li>
                              ))}
                           </ul>
                        </div>
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm text-left">
                     <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100 last:border-0 text-left">
                        <h3 className="text-xl font-black text-navy uppercase italic tracking-tighter leading-none">Detail Evaluation</h3>
                        <div className="text-[8px] bg-gray-50 text-gray-400 italic px-3 py-1.5 rounded-full uppercase tracking-widest font-black font-mono">Score Matrix</div>
                     </div>

                     <div className="space-y-8">
                        {((specConfig as any).criteria || []).map((crt: any, i: number) => {
                           const key = crt.name.toLowerCase();
                           const score = evaluation ? (evaluation as any).detailedScores?.[key] || 9.2 : 9.2;
                           const detailText = evaluation ? (evaluation as any).details?.[key] || "Verified as our high performing metric aspect of testing." : "Verified as our high performing metric aspect of testing.";
                           
                           return (
                              <div key={i} className="flex flex-col gap-3 relative pb-6 border-b border-gray-50 last:border-0 last:pb-0 text-left">
                                 ...
                                 <div className="w-full bg-gray-50 h-1.5 rounded-full overflow-hidden">
                                    <div className="bg-[#1B5CFF] h-full" style={{ width: `${score * 10}%` }} />
                                 </div>
                                 <p className="text-[11px] font-semibold text-gray-400 italic uppercase tracking-wider leading-relaxed text-left">{detailText}</p>
                              </div>
                           );
                        })}
                     </div>
                  ...
                  <div id="top-3" className="scroll-mt-36">
                     <div className="mb-4 text-left">
                        <h2 className="text-2xl font-black text-[#1A1D4E] italic tracking-tighter uppercase mb-0.5">OTHER PRODUCTS MENTIONED | TOP 3</h2>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] italic">High-tier alternative models evaluated</p>
                     </div>
                  ...
                  <div id="all-products" className="scroll-mt-36">
                     <div className="mb-4 text-left">
                        <h2 className="text-2xl font-black text-[#1A1D4E] italic tracking-tighter uppercase mb-0.5">OTHER PRODUCTS MENTIONED</h2>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] italic">Every model covered during continuous testing</p>
                     </div>
               ...
               <aside className="hidden lg:flex flex-col gap-6 sticky top-[160px] max-h-[calc(100vh-180px)] overflow-y-auto no-scrollbar pb-10 flex-shrink-0">
                  ...
                  <div id="reviewer-profile" className="bg-white border border-[#e8edf2] rounded-2xl p-4.5 shadow-sm flex flex-col items-center text-center scroll-mt-36">
                     ...
                     <h4 className="text-base font-black text-navy italic tracking-tighter uppercase mb-1 leading-none">{creator.name}</h4>
                     <span className="text-[8px] font-black text-orange-primary uppercase tracking-widest italic bg-orange-primary/5 px-2.5 py-1 rounded border border-orange-primary/10 mb-4">{creator.verifiedStatus}</span>
                     ...
                     <div className="flex gap-3 justify-center mb-5 shrink-0">
                        {creator.socials.facebook && (
                           <a href={creator.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all shadow-sm"><Facebook size={12} /></a>
                        )}
                        {creator.socials.twitter && (
                           <a href={creator.socials.twitter} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-sky-50 text-sky-500 flex items-center justify-center hover:bg-sky-500 hover:text-white transition-all shadow-sm"><Twitter size={12} /></a>
                        )}
                        {creator.socials.youtube && (
                           <a href={creator.socials.youtube} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-red-50 text-red-600 flex items-center justify-center hover:bg-red-600 hover:text-white transition-all shadow-sm"><Youtube size={12} /></a>
                        )}
                     </div>
                  ...
                  {(guide.id === 1 || (guide as any).isSponsored || (dynamicData as any).isSponsoredContent) && (
                     <div className="bg-white border border-[#e8edf2] rounded-2xl p-4.5 shadow-sm text-[#1a1a2e] text-center relative overflow-hidden">
                        ...
                        <div className="w-full aspect-square rounded-xl overflow-hidden mb-5 border border-white/10 shadow-lg">
                           <img src="https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=400" className="w-full h-full object-cover" alt="Sponsored" />
                        </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 w-full mb-32">
        <section className="pt-20 border-t border-gray-100">
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 text-left">
              ...
              <Link to="/guides" className="px-10 py-5 bg-navy text-white rounded-full text-[11px] font-black uppercase tracking-widest italic hover:bg-[#E8500A] transition-all shadow-xl font-bold">
                ...
                <Link key={i} to={`/guides/${g.id}`} className="group cursor-pointer block bg-[#FDFDFD] rounded-[24px] overflow-hidden border border-gray-100 hover:shadow-2xl transition-all duration-500 shadow-xl shadow-gray-100/50">
                  ...
                  <div className="p-8 text-left">
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                         ...
                         <ArrowRight size={16} className="text-[#E8500A] group-hover:translate-x-2 transition-transform" />
                      </div>
                  </div>
                </Link>
              ))}
