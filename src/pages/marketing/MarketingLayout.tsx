      ...
      <header className="bg-white border-b border-[#e8edf2] px-6 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm">
            <Link to="/dashboard" className="text-gray-400 hover:text-[#EF3C23]">Dashboard</Link>
            <ChevronRight size={14} className="text-gray-300" />
            <Link to="/marketing/content" className="font-bold text-navy hover:text-[#EF3C23]">Marketing</Link>
            {moduleLabel && moduleLabel !== 'Marketing' && (
              <>
                <ChevronRight size={14} className="text-gray-300" />
                <span className="font-semibold text-[#FF5B00]">{moduleLabel}</span>
              </>
            )}
          </div>
        </div>
