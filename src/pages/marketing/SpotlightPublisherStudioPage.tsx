  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-8">
        <Sparkles className="h-10 w-10 text-[#FF5B00] mx-auto mb-3" aria-hidden />
        ...
        {PUBLISHER_CONTENT_TYPE_REGISTRY.map((t) => (
          <button
            ...
            className={cn(
              ...
              'hover:border-[#FF5B00]/40 hover:bg-[#EF3C23]/5 transition-colors',
            )}
          >
    ...
    return (
      <div className="min-h-screen bg-[#F8FBFD]">
        <div className="border-b border-[#e8edf2] bg-white px-4 py-3">
          <Link
            to="/marketing/studio"
            className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#EF3C23]"
          >
  ...
  return (
    <div className="min-h-screen bg-[#F8FBFD]">
      <div className="border-b border-[#e8edf2] bg-white px-4 py-2">
        <Link
          to="/marketing/studio"
          className="inline-flex items-center gap-2 text-xs text-gray-500 hover:text-[#EF3C23]"
        >
