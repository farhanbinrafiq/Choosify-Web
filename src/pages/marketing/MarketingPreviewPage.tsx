      ...
      {previewTarget === 'content' ? (
        <div className="space-y-3">
          {contentItems.length === 0 ? (
            <p className="text-sm text-gray-500">
              No content to preview. <Link to="/marketing/content/new" className="text-[#FF5B00] hover:underline">Create content</Link>
            </p>
          ) : (
            <>
              <select
        ...
        <div className="space-y-3">
          {sponsoredItems.length === 0 ? (
            <p className="text-sm text-gray-500">
              No campaigns to preview. <Link to="/marketing/sponsored/new" className="text-[#FF5B00] hover:underline">Create campaign</Link>
            </p>
          ) : (
            <>
              <select
