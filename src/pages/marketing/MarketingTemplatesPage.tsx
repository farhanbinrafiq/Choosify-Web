  ...
  return (
    <div className="flex-grow p-6 space-y-6 max-w-4xl">
        ...
        {CMS_TEMPLATE_REGISTRY.map((t) => (
          <div key={t.id} className="bg-white border border-[#e8edf2] rounded-lg p-5 flex flex-col">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 text-xs font-bold uppercase bg-[#FF5B00] text-white rounded w-fit"
            >
              Use Template
            </button>
          </div>
      ...
      <p className="text-xs text-gray-400">
        ...
        <Link to="/marketing/content" className="text-[#FF5B00] hover:underline">Spotlight Content</Link> editor.
      </p>
    </div>
  );
}
