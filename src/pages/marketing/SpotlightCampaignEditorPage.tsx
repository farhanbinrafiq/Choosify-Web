  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={saveDraft} className="flex items-center gap-1 text-sm font-bold text-[#FF5B00]">
        ...
        {STEPS.map((label, i) => (
          <li
            ...
            className={cn(
              ...
              draft.step === i + 1 ? 'bg-[#FF5B00] text-white' : 'bg-white border border-[#e8edf2] text-gray-400',
            )}
          >
            {i + 1}. {label}
          </li>
        ...
        {draft.step === 6 && (
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button type="button" onClick={submitForReview} className="px-4 py-2 bg-[#FF5B00] text-white rounded text-sm font-bold">
                Submit for Review
              </button>
              {canModerate(actor) && (
