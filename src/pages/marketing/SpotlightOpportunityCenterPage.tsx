  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#1A1A2E] tracking-tight flex items-center gap-2">
            <Lightbulb size={24} className="text-[#FF5B00]" aria-hidden />
        ...
        <div className="flex flex-wrap gap-2">
          <Link to="/marketing/intelligence" className="inline-flex items-center gap-1 text-[10px] font-bold uppercase text-gray-400 hover:text-[#EF3C23]">
      ...
      <div className="bg-white border border-[#e8edf2] rounded-lg p-3 flex flex-wrap gap-3 items-center">
        ...
        <button type="button" onClick={center.resetFilters} className="text-[10px] font-bold uppercase text-gray-400 hover:text-[#EF3C23] ml-auto">
          Reset
        </button>
      </div>
