  ...
  if (!collection) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <Link to="/spotlight/explore?tab=collections" className="mt-4 inline-block text-[#FF5B00] text-sm font-bold uppercase">
          Browse collections
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <header className="mb-8 text-left">
        <span className="text-[10px] font-black uppercase text-[#FF5B00]">{collection.kind}</span>
