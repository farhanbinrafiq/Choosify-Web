...
export function OrderSuccessPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
      {/* Visual Header */}
      <div className="w-full bg-[#0A0B1E] pt-16 pb-24 px-4 text-center text-white relative overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 bg-gradient-to-b from-[#F96500]/10 via-[#0A0A1F] to-[#0A0A1F] opacity-95" />
