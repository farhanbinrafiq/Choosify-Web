...
const DEFAULT_EVENT_BADGES: SiteContentBadge[] = [
  { id: 'event', label: 'Event', color: '#FF5B00', entityType: 'event', mapsTo: 'event', priority: 1, isActive: true },
  { id: 'announcement', label: 'Announcement', color: '#1A1D4E', entityType: 'event', mapsTo: 'announcement', priority: 2, isActive: true },
  { id: 'festival', label: 'Festival', color: '#EF3C23', entityType: 'event', mapsTo: 'festival', priority: 3, isActive: true },
