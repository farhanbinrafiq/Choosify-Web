...
export const DASHBOARD_NAV_REGISTRY: DashboardNavItem[] = [
  ...
  { id: 'to-pay', label: 'To Pay', icon: 'Banknote', group: 'platform', roles: ['buyer'] },
  { id: 'my-cancellations', label: 'My Cancellations', icon: 'Ban', group: 'platform', roles: ['buyer'] },
  { id: 'my-returns', label: 'My Returns', icon: 'RotateCcw', group: 'platform', roles: ['buyer'] },
  { id: 'my-refund', label: 'My Refund', icon: 'Wallet', group: 'platform', roles: ['buyer'] },
  { id: 'my-warranty', label: 'My Warranty', icon: 'ShieldCheck', group: 'platform', roles: ['buyer'] },
  { id: 'my-payment-options', label: 'My Payment Options', icon: 'CreditCard', group: 'platform', roles: ['buyer'] },
