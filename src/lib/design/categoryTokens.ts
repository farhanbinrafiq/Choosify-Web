...
export const CATEGORY_QUICK_NAV_ITEMS = [
  { id: 'fashion', label: 'Fashion & Lifestyle', sub: '230 Products', letter: 'F', bg: '#FFF3EA', filterType: 'Fashion' },
  { id: 'electronics', label: 'Electronics', sub: '270 Products', letter: 'T', bg: '#EAF1FD', filterType: 'Electronics' },
  { id: 'home', label: 'Home, Furniture & Appliances', sub: '310 Products', letter: 'H', bg: '#E6F9EA', filterType: 'Home & Living' },
  { id: 'beauty', label: 'Beauty, Health & Pharmacy', sub: '350 Products', letter: 'B', bg: '#FDECEC', filterType: 'Beauty' },
  { id: 'sports', label: 'Sports, Fitness & Outdoor', sub: '390 Products', letter: 'S', bg: '#FEF3E2', filterType: 'Sports' },
