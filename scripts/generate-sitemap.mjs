...
const STATIC_PATHS = [
  ...
  { path: '/spotlight', changeFrequency: 'daily', priority: 0.92 },
  { path: '/spotlight/explore', changeFrequency: 'daily', priority: 0.88 },
  { path: '/spotlight/search', changeFrequency: 'weekly', priority: 0.75 },
  { path: '/spotlight/calendar', changeFrequency: 'daily', priority: 0.8 },
  { path: '/spotlight/stories', changeFrequency: 'daily', priority: 0.7 },
  { path: '/spotlight/collections', changeFrequency: 'daily', priority: 0.82 },
  { path: '/spotlight/series', changeFrequency: 'weekly', priority: 0.78 },
