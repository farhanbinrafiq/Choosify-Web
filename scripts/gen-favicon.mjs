...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3508 3508" width="512" height="512">
...
const png16 = pngs.find((p) => p.size === 16).buf;
const png32 = pngs.find((p) => p.size === 32).buf;
